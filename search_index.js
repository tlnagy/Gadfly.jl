...

{
    ...
    "title": "Rendering Pipeline",
    "category": "section",
    "text": "using DataFrames # hide\nusing Colors # hide\nusing Compose # hide\nusing RDatasets # hide\nusing Showoff # hide\nusing Gadfly # hideHow does the function calldf = dataset(\"ggplot2\", \"diamonds\")\np = plot(df,\n         x = :Price, color = :Cut,\n		 Stat.histogram,\n		 Geom.bar)actually get turned into the following plot?df = dataset(\"ggplot2\", \"diamonds\") # hide\np = plot(df, # hide\n         x = :Price, color = :Cut, # hide\n		 Stat.histogram, # hide\n		 Geom.bar) # hide\np_rendered = deepcopy(p) # hide"
},
...

{
    ...
    "title": "Examples",
    "category": "section",
    "text": "using RDatasets # hide\nusing Gadfly # hide\nGadfly.set_default_plot_size(12cm, 8cm) # hideplot(dataset(\"HistData\", \"ChestSizes\"), x=\"Chest\", y=\"Count\", Geom.bar)"
},
...

{
    ...
    "title": "Examples",
    "category": "section",
    "text": "using RDatasets # hide\nusing Gadfly # hide\nGadfly.set_default_plot_size(14cm, 8cm) # hide# Binding categorial data to x\nplot(dataset(\"lattice\", \"singer\"), x=\"VoicePart\", y=\"Height\", Geom.beeswarm)"
},
...

{
    ...
    "title": "Examples",
    "category": "section",
    "text": "using RDatasets # hide\nusing Gadfly # hide\nGadfly.set_default_plot_size(14cm, 8cm) # hideplot(dataset(\"lattice\", \"singer\"), x=\"VoicePart\", y=\"Height\", Geom.boxplot)"
},
...

{
    ...
    "title": "Examples",
    "category": "section",
    "text": "using RDatasets # hide\nusing Gadfly # hide\nGadfly.set_default_plot_size(14cm, 8cm) # hideplot(dataset(\"ggplot2\", \"diamonds\"), x=\"Price\", Geom.density)plot(dataset(\"ggplot2\", \"diamonds\"), x=\"Price\", color=\"Cut\", Geom.density)"
},
...

{
    ...
    "title": "Examples",
    "category": "section",
    "text": "using Gadfly, Distributions # hide\nGadfly.set_default_plot_size(14cm, 8cm) # hideX = rand(MultivariateNormal([0.0, 0.0], [1.0 0.5; 0.5 1.0]), 10000);\nplot(x=X[1,:], y=X[2,:], Geom.hexbin)plot(x=X[1,:], y=X[2,:], Geom.hexbin(xbincount=100, ybincount=100))"
},
...

{
    ...
    "title": "Examples",
    "category": "section",
    "text": "using RDatasets # hide\nusing Gadfly # hide\nGadfly.set_default_plot_size(14cm, 10cm) # hideplot(dataset(\"ggplot2\", \"mpg\"), x=\"Cty\", y=\"Hwy\", label=\"Model\", Geom.point, Geom.label)plot(dataset(\"MASS\", \"mammals\"), x=\"Body\", y=\"Brain\", label=1,\n     Scale.x_log10, Scale.y_log10, Geom.point, Geom.label)plot(dataset(\"MASS\", \"mammals\"), x=\"Body\", y=\"Brain\", label=1,\n     Scale.x_log10, Scale.y_log10, Geom.label(position=:centered))"
},
...

{
    ...
    "title": "Examples",
    "category": "section",
    "text": "using RDatasets # hide\nusing Gadfly # hide\nGadfly.set_default_plot_size(14cm, 8cm) # hideplot(dataset(\"lattice\", \"melanoma\"), x=\"Year\", y=\"Incidence\", Geom.line)plot(dataset(\"Zelig\", \"approval\"), x=\"Month\",  y=\"Approve\", color=\"Year\", Geom.line)"
},
...

{
    ...
    "title": "Examples",
    "category": "section",
    "text": "using Gadfly # hide\nGadfly.set_default_plot_size(14cm, 8cm) # hideplot(x=[0, 1, 1, 2, 2, 3, 3, 2, 2, 1, 1, 0, 4, 5, 5, 4],\n     y=[0, 0, 1, 1, 0, 0, 3, 3, 2, 2, 3, 3, 0, 0, 3, 3],\n     group=[\"H\", \"H\", \"H\", \"H\", \"H\", \"H\", \"H\", \"H\",\n            \"H\", \"H\", \"H\", \"H\", \"I\", \"I\", \"I\", \"I\"],\n     Geom.polygon(preserve_order=true, fill=true))"
},
...

{
    ...
    "title": "Examples",
    "category": "section",
    "text": "using RDatasets # hide\nusing Gadfly # hide\nGadfly.set_default_plot_size(14cm, 8cm) # hideplot(dataset(\"Zelig\", \"macro\"), x=\"Year\", y=\"Country\", color=\"GDP\", Geom.rectbin)"
},
...

{
    ...
    "title": "Examples",
    "category": "section",
    "text": "using Gadfly # hide\nGadfly.set_default_plot_size(14cm, 8cm) # hide\nsrand(1234) # hide\nnothing # hideplot(x=rand(25), y=rand(25), Geom.step)"
},
...

{
    ...
    "title": "Examples",
    "category": "section",
    "text": "using RDatasets # hide\nusing Gadfly # hide\nGadfly.set_default_plot_size(14cm, 8cm) # hideplot(dataset(\"lattice\", \"singer\"), x=\"VoicePart\", y=\"Height\", Geom.violin)"
},
...

{
    ...
    "title": "Examples",
    "category": "section",
    "text": "using RDatasets # hide\nusing Gadfly # hide\nGadfly.set_default_plot_size(14cm, 8cm) # hidevolcano = float(convert(Array, dataset(\"datasets\", \"volcano\")))\nplot(z=volcano, Geom.contour, Guide.colorkey(\"Elevation\"))"
},
...

{
    ...
    "title": "Examples",
    "category": "section",
    "text": "Combine two layers into a plot, and set a custom color of one layer.  Add a manual color key with labels that match the two layers.  (Note that \"deepskyblue\" is the default color for Geom.line and others.)using DataFrames # hide\nusing Gadfly # hide\nGadfly.set_default_plot_size(14cm, 8cm) # hidepoints = DataFrame(index=rand(0:10,30), val=rand(1:10,30))\nline = DataFrame(val=rand(1:10,11), index = [0:10])\npointLayer = layer(points, x=\"index\", y=\"val\", Geom.point,Theme(default_color=colorant\"green\"))\nlineLayer = layer(line, x=\"index\", y=\"val\", Geom.line)\nplot(pointLayer, lineLayer, Guide.manual_color_key(\"Legend\", [\"Points\", \"Line\"], [\"green\", \"deepskyblue\"]))"
},
...

{
    ...
    "title": "Examples",
    "category": "section",
    "text": "using RDatasets # hide\nusing Gadfly # hide\nGadfly.set_default_plot_size(14cm, 8cm) # hideplot(dataset(\"ggplot2\", \"diamonds\"), x=\"Price\", Geom.histogram, Guide.title(\"Diamond Price Distribution\"))"
},
...

{
    ...
    "title": "Examples",
    "category": "section",
    "text": "using Gadfly # hide\nGadfly.set_default_plot_size(14cm, 8cm) # hideplot(cos, 0, 2π, Guide.xlabel(\"Angle\"))plot(cos, 0, 2π, Guide.xlabel(\"Angle\", orientation=:vertical))plot(cos, 0, 2π, Guide.xlabel(nothing))"
},
...

{
    ...
    "title": "Examples",
    "category": "section",
    "text": "using Compose # hide\nusing Gadfly # hide\nGadfly.set_default_plot_size(14cm, 8cm) # hideplot(x=rand(20), y=rand(20), Guide.xrug)"
},
...

{
    ...
    "title": "Examples",
    "category": "section",
    "text": "using Gadfly # hide\nGadfly.set_default_plot_size(14cm, 8cm) # hideplot(cos, 0, 2π, Guide.ylabel(\"cos(x)\"))plot(cos, 0, 2π, Guide.ylabel(\"cos(x)\", orientation=:horizontal))plot(cos, 0, 2π, Guide.ylabel(nothing))"
},
...

{
    ...
    "title": "Examples",
    "category": "section",
    "text": "using Compose # hide\nusing Gadfly # hide\nGadfly.set_default_plot_size(14cm, 8cm) # hideplot(x=rand(20), y=rand(20), Guide.yrug)"
},
...

{
    ...
    "title": "Examples",
    "category": "section",
    "text": "using RDatasets # hide\nusing Gadfly # hide\nGadfly.set_default_plot_size(12cm, 8cm) # hidep1 = plot(dataset(\"datasets\", \"iris\"), x=\"SepalLength\", y=\"SepalWidth\", Stat.binmean, Geom.point)"
},
...

{
    ...
    "title": "Examples",
    "category": "section",
    "text": "using Distributions # hide\nusing Gadfly # hide\nGadfly.set_default_plot_size(12cm, 8cm) # hide\nsrand(1234) # hide\nnothing # hideplot(x=rand(Normal(), 100), y=rand(Normal(), 100), Stat.qq, Geom.point)\nplot(x=rand(Normal(), 100), y=Normal(), Stat.qq, Geom.point)"
},
...

{
    ...
    "title": "Arguments",
    "category": "section",
    "text": "direction: Either :hv for horizontal then vertical, or :vh for vertical then horizontal.using Gadfly # hide\nGadfly.set_default_plot_size(12cm, 8cm) # hide\nsrand(1234) # hide\nnothing # hideplot(x=rand(25), y=rand(25), Stat.step, Geom.line)"
},
...

{
    ...
    "title": "Examples",
    "category": "section",
    "text": "using Gadfly # hide\nsrand(1234) # hide\nnothing # hideThis forces the use of a discrete scale on data that would otherwise receive a continuous scale:plot(x=rand(12), y=rand(12), color=repeat([1,2,3], outer=[4]),\n     Scale.color_discrete())"
},
...

{
    ...
    "title": "Examples",
    "category": "section",
    "text": "using RDatasets # hide\nusing Gadfly # hide\nsrand(1234) # hide\nGadfly.set_default_plot_size(12cm, 8cm) # hide# Treat numerical x data as categories\nplot(x=rand(1:3, 20), y=rand(20), Scale.x_discrete)"
},
...

{
    ...
    "title": "Examples",
    "category": "section",
    "text": "using RDatasets # hide\nusing Gadfly # hide\nsrand(1234) # hide\nGadfly.set_default_plot_size(12cm, 8cm) # hide# Treat numerical y data as categories\nplot(x=rand(20), y=rand(1:3, 20), Scale.y_discrete, Geom.point)"
},
